...
@Controller
public class AccountLinkCallbackController extends AbstractCallbackController {

    @Autowired
    public AccountLinkCallbackController(ApplicationConfig appConfig) {
        super(appConfig, appConfig.getAccountLinkRedirectOnSuccess(), appConfig.getAccountLinkRedirectOnFail());
    }
